            ...
            <div class="container">
                <div class="row" style="flex-direction: column; align-items: center;">
                    <h2 class="display-5 text-shadow font-weight-bold" style="margin-bottom: 50px; color:#00090b;">Отзывы о курсе</h2>
                        ...
                        <div class="col-sm-9">
                            <div class="review-block-description" data-item="' . $idcomments . '" id = idcomments name = "idcomments[' . $count . ']">' . $textcomment . '</div>
                    ...
                    <div class="row" style="flex-direction: column; align-items: center;">
                        ...
                        <?php if ($_SESSION['roleid'] == 1) {
                            if (isset($_POST["deleteComment"])) {
                                $query3 = "DELETE FROM comments WHERE idcomments ='$idcomments';";
