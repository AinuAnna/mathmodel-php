<header class="header">
  <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
    <div class="container-fluid">
      ...
      if ($row['avatar'] == '') {
        echo '<span class = "account-user-avatar"><a href = "student.php"><img src = "../assets/user-avatar.svg" width= 32px; height= 32px;></a></span>
                <span class = "nav-user">
                <span class="account-user-name">' . $row['fullname'] . '</span>
                <span class="account-position">' . $row['email'] . '</span>
                </span>';
      } else {
        echo "<span class = 'account-user-avatar'><a href = 'student.php'><img src = '" . $row['avatar'] . "' width= 32px; height= 32px; style = 'object-fit: cover; border-radius: 50%'></a></span>
